                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><div class="td-content"><a href="{{ route('orders.invoice', $recent_order->id) }}" >{{ $recent_order->order_number }}</a></div></td>
                                <td><div class="td-content product-brand">{{ $recent_order->created_at->format("d-m-y") }}</div></td>
                                <td><div class="td-content customer-name">{{ $recent_order->user ? $recent_order->user->name : __("messages.visitor") }}</div></td>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><div class="td-content"><span class="pricing">{{ $sold_product->price_before_offer . " " . __('messages.dinar') }}</span></div></td>
                                <td><div class="td-content"><span class="discount-pricing">{{ $sold_product->final_price . " " . __('messages.dinar') }}</span></div></td>
        ...
        <a href="{{ route('brands.index') }}" >
            <div class="widget widget-card-four">
                <div class="widget-content">
                    <div class="w-content">
                        <div class="w-info">
                            <h6 class="value">{{ $data['brands'] }}</h6>
                            <p class=""> {{ __('messages.brands_count') }}</p>
                        </div>
                        <div class="">
                            <div class="w-icon">
