    ...
    <form method="post" action="" enctype="multipart/form-data" >
        @csrf
         <div class="form-group mb-4">
            ...
            <br>
            <img src="https://res.cloudinary.com/dz3o88rdi/image/upload/w_100,q_100/v1581928924/{{$data['setting']['logo']}}" >    
        </div>
        ...
        <div class="form-group mb-4">
            ...
            <input  type="text" name="min_order" class="form-control" id="min_order" placeholder="{{ __('messages.min_order') }}" value="{{$data['setting']['min_order']}}" >
        </div>
