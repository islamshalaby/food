                                    ...
                                    <div class="nav-link list-actions" id="invoice-{{ $data['order']['order_number'] }}" data-invoice-id="{{ $data['order']['order_number'] }}">
                                        <div class="f-m-body">
                                            ...
                                            <div class="f-body">
                                                ...
                                                <p class="invoice-customer-name"><span>{{ __('messages.to') }}:</span> {{ $data['order']->user ? $data['order']->user->name : __("messages.visitor") }}</p>
                            ...
                            <div class="invoice-{{ $data['order']['order_number'] }}">
                                <div class="content-section  animated animatedFadeInUp fadeInUp">
                                    ...
                                    <div class="row inv--head-section">
                                        ...
                                        <div class="col-sm-6 col-12 align-self-center text-sm-right">
                                            <div class="company-info">
                                                <img src="https://res.cloudinary.com/dz3o88rdi/image/upload/w_100,q_100/v1581928924/<?=Auth::user()->custom['setting']['logo']?>" class="navbar-logo" alt="logo">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row inv--detail-section">
                                        ...
                                        <div class="col-sm-7 align-self-center">
                                            <p style="font-size: 18px;" class="inv-customer-name">{{ $data['order']->user ? $data['order']->user->name : __("messages.visitor") }}</p>
