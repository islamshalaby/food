                    ...
                    <tbody>
                        ...
                        @foreach ($data['orders'] as $order)
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="{{ !empty($order->user_id) ? route('users.details', $order->user_id) : '#' }}">
                                    {{ $order->user ? $order->user->name : __("messages.visitor") }}
                                    </a>
                                </td>
                                <td>
                                ...
                                <td class="hide_col text-center">
                                    ...
                                    <a href="{{ route('orders.action', [$order->id, 2]) }}" onclick='return confirm("{{ __('messages.are_you_sure') }}");' class="btn btn-sm btn-success hide_col">
